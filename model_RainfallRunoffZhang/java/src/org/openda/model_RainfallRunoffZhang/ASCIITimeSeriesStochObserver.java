 ...
 * <p>
 * The input file for this class has the following format<pre>
 *   &lt;?xml version="1.0" encoding="UTF-8"?&gt;<br>
 *   &lt;noosObserver xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"&gt;<br>
 ...
 *   - maxDateTime
 *   
 * @author verlaanm, slightly modified by Beatrice Marti, hydrosolutions ltd.
 *
 */
public class ASCIITimeSeriesStochObserver extends ASCII_TimeSeriesStochObserver {
		...
		if(file.exists()){
			...
			for(int i=0;i<seriesTrees.length;i++){
				...
				if(seriesFile.exists()){
					tempSeries = ASCIIFormatter.readFile(seriesFile.getAbsolutePath());
