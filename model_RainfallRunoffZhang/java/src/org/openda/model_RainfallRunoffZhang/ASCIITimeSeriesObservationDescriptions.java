...
public class ASCIITimeSeriesObservationDescriptions implements IObservationDescriptions {
	...
	//Class fields
	public ASCII_TimeSeriesStochObserver obs = null;

	public ASCIITimeSeriesObservationDescriptions(){
		//TODO empty ObservationDescriptions
	}

	public ASCIITimeSeriesObservationDescriptions(ASCII_TimeSeriesStochObserver obs){
       this.obs = obs;
	}
