...
/**
 * Calls an example python bmi model through the thrift bmi bridge with
 * multi-node support.
 * 
 * @author Niels Drost
 *
 */
public class ClusterPythonIncrementModelBridgeTest extends AbstractIncrementModelBridgeTest {
	...
	protected EBMI createModel() throws Exception {
		...
		//will use ssh although actually localhost
		String host = "localhost";

		EBMI model = BmiModelFactory.createModelBridge(host, pythonExecutable, opendaPythonPath, modelPythonPath, modelPythonModuleName, modelPythonClassName, modelWorkDir);
