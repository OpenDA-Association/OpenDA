 ...
 */
public class EfdcScalarExchangeItemXspeciesTest extends TestCase {
    private OpenDaTestSupport testData;

    protected void setUp() {
    	testData = new OpenDaTestSupport(EfdcScalarExchangeItemXspeciesTest.class,"model_efdc_dll");
    }
