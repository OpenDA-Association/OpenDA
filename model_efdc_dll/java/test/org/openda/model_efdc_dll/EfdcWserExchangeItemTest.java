 ...
 */
public class EfdcWserExchangeItemTest extends TestCase {
    private OpenDaTestSupport testData;

    protected void setUp() {
    	testData = new OpenDaTestSupport(EfdcWserExchangeItemTest.class,"model_efdc_dll");
    }
    ...
    public void testScalarExchangeItem() {
        ...
        runModelInstancesWserTest(fortranDll, modelInstancesParentDir, instanceCount);


    }

    private static void runModelInstancesWserTest(File simpleFortranDll, File modelParentDir, int instanceCount) {

        IModelInstance[] modelInstances = new EfdcModelInstance[instanceCount];

        String[] exchangeItemIDs = new String[2];

        exchangeItemIDs[0] = "1.WindSpeed";
        exchangeItemIDs[1] = "1.WindDirection";


        // create instance directories and intialize the model instances
        File modelTemplateDir = new File(modelParentDir, "model_wser");
        ...
        for (int i = 0; i < instanceCount; i++) {
            ...
            modelInstances[i] = new EfdcModelInstance(instanceDir, new String[]{}, "model_output.nc", "analysis_output.nc", i, true, true, null);
        }
        ...
        for (IModelInstance modelInstance : modelInstances) {
            ...
            for (String exchangeItemId : exchangeItemIDs ) {
                ...
                newTimes[times.length] = newTimes[times.length-1] +1;
