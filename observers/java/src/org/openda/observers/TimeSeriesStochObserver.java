...
/**
 * Implementation of IStochObserver for data consisting of several timeseries.
 ...
 * - The property 'standardDeviation' of each TimeSeries given the spread of the errors
 * This class is easily extended to import the data from some source. The recommended way for this
 * is to extend this class an make use of a TimeSeriesFormatter.
 * @author verlaanm
 *
 */
public class TimeSeriesStochObserver extends Instance implements IStochObserver {
	 ...
	 * Generic constructor
	 */
	public TimeSeriesStochObserver(){
	...
	public IStochObserver createSelection(ITime selectionTimes) {
		...
		return new TimeSeriesStochObserver(selectedSeriesCleaned);
	}
	...
	public IObservationDescriptions getObservationDescriptions() {
		return new TimeSeriesObservationDescriptions(this);
	}
