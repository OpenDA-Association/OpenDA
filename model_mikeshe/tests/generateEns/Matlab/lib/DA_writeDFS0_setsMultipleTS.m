function [ filename ] = DA_writeDFS0_setsMultipleTS(filename, data)
%DA_writeDFS0_setsMultipleTS Sets multimple time series to a PRE-EXISTING dfs0
%
% Inputs, 
%   filename
%   data ( timeTS  ,  itemNumber )
%
% Outputs,
