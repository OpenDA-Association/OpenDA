 ...
 *
 */
public class ObservationOperatorLocalizationModel implements IObservationOperator {

	private IStochModelInstanceLocalization ModelInstance;
	 ...
	 */
	public ObservationOperatorLocalizationModel(IStochModelInstanceLocalization model) {
		ModelInstance = model;
	}
	...
	public IVector getObservedValues(IObservationDescriptions observationDescriptions, int iDomain)	{
		return ModelInstance.getObservedValues(observationDescriptions, iDomain);
	}
