		...
		for (int i = 1; i < arguments.length; i++) {
			...
			switch (key) {
				...
				default:
					...
					throw new RuntimeException("Unknown key " + key + ". Please specify one of the next key=value pairs " + ALLOW_TIME_INDEPENDENT_ITEMS + ", " + REQUIRED_EXCHANGE_ITEM_ID + ", " + TIME_DIMENSION_NAME + ", " + GRID_DIMENSION_NAME + '?');
			}
		}
