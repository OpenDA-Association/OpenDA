...
/**
 * Class implementing a correlation model with a linear structure
 * for autocorrelation.
 *
 * This class is derived from DUE version 3.0 by brown@science.uva.nl
 */
public class LinearCorrelation extends AutoCorrelationFunction {

	//distribution name.
	private static final String DISTRIBUTION_NAME = "LinearWithSill";


	/**
	 * Returns a new instance of this correlation object for cloning purposes.
	 *
	 * @return new instance of LinearCorrelation.
	 */
	public LinearCorrelation newInstance() {
        return new LinearCorrelation() ;
    }

	/**
	 * Construct a Linear correlation model with default values for the parameters.
	 */
    ...
    /**
     * Construct an isotropic Linear correlation model with a sill and range as input parameters
     *
     * @param sill the sill parameter
     * @param range the range parameter
     * @throws IllegalArgumentException if range <= 0
     */
	public LinearCorrelation(double sill, double range) throws IllegalArgumentException {
		super();
