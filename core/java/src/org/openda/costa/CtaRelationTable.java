...
import org.openda.interfaces.IRelationTable;
import org.openda.interfaces.IVector;

public class CtaRelationTable extends CtaObject implements IRelationTable {
	    ...
	    *
	    */
	   public CtaRelationTable(IRelationTable hrel1, boolean inverse1,
	                        IRelationTable hrel2, boolean inverse2 ){
		   this.ctaHandle=ctaCreate();
		   this.SetTableCombine(hrel1, inverse1, hrel2, inverse2 );
	   }

	   private native int ctaCreate();
       private native void SetTableCombine(IRelationTable hrel1, boolean inverse1,
               IRelationTable hrel2, boolean inverse2 );

       private native void SetSelect(IVector vselect);
	   public native void apply(IVector hfrom, IVector hto);
	   public native void applyInv(IVector hfrom, IVector hto);
