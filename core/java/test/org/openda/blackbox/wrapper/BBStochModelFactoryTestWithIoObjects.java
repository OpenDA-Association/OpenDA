 ...
 * This test makes sure that IoObject can still be used (until they are really removed)
 */
public class BBStochModelFactoryTestWithIoObjects extends TestCase {

    private File testRunDataDir;

    protected void setUp() throws IOException {
        OpenDaTestSupport testData = new OpenDaTestSupport(BBStochModelFactoryTestWithIoObjects.class, "core");
        testRunDataDir = testData.getTestRunDataDir();
    }

    public void testIoObjectConfigWithTime () {
        BBStochModelFactory bbStochModelFactory = new BBStochModelFactory();
        File testData = new File(testRunDataDir,"ioObjectConfig");
