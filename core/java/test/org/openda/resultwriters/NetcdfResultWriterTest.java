 ...
 */
public class NetcdfResultWriterTest extends TestCase {
	...
	protected void setUp() throws IOException {
		testData = new OpenDaTestSupport(NetcdfResultWriterTest.class, "core");
	...
	public void testAllOutput() {  // first implementation
		...
		//setTestDir();
		Results.reset();
		IResultWriter netcdfWriter = new NetcdfResultWriter(testRunDataDir, "de_test_.nc");
	...
	private void generateAsciiDump(String nameNcFile, String nameTextFile){
		...
		try{
			...
			throw new RuntimeException("NetcdfResultWriter junit test. Problem with ascii dump of netcdf.");
		}
	}
}
