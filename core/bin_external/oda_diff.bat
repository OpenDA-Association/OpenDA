...
rem
rem Purpose : startup script for the DataObjectDiff tool. 
rem Args    : use -h
rem Examples: oda_diff.bat
...
"%JAVA_HOME%\jre\bin\java" -classpath %OPENDA_BINDIR%\* org.openda.exchange.iotools.DataObjectDiff %*
