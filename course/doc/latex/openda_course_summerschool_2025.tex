...
\newpage
\section*{Python}
You need to have python installed on your computer for examining and plotting the results of the experiments.
Linux and Mac users need python to run the model from exercise 4,5, and 6).
