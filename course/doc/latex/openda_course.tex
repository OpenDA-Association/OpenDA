...
\section{Exercise 3: Writing your own toy model}
...
OpenDA. The directory {\tt exercise\_3} contains a template of the code for the
...
In the directory\\ {\tt
  exercise\_3/simple\_advection\_model/java/src/org/openda} you will find the
...
\item You can compile your model by typing "ant build" in the directory \\ {\tt
  exercise\_3/simple\_advection\_model}. This will create the file \\ {\tt
...
\section{Exercise 4: Steady-state}
...
\item Look at the implementation of the model in {\tt
  WaveStochModelInstance.java}. See how the state is defined and how the model
  is discretized. Compile the model using {\tt ant build} like you have done
  with your own model in exercise 3.
...
\section{Exercise 5: A black box model - Calibration}
...
In the directory {\tt exercise\_5/} you will find a model written in python \\
...
The Java-routines are located in directory {\tt reactive\_advection\_wrapper}.
You can compile the code with 'ant build' as in exercise 3. To add the jar-file
to OpenDA, either use the CLASSPATH environment variable or copy the jar-file
into the bin directory of your OpenDA version.
...
\section{Exercise 6: A black box model - Filtering}
