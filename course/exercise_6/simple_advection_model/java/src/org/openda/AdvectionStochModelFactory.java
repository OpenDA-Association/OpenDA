 ...
 */
public class AdvectionStochModelFactory extends SimpleStochModelFactory {

    public IStochModelInstance getInstance(OutputLevel outputLevel) {
    	AdvectionStochModelInstance result = new AdvectionStochModelInstance(this.workingDir, this.arguments[0]);
    	result.outputLevel = outputLevel;
        return new AdvectionStochModelInstance(this.workingDir, this.arguments[0]);
    }

    public IStochModelPostProcessor getPostprocessorInstance(File instanceDir) {
        throw new UnsupportedOperationException("org.openda.AdvectionStochModelFactory.getPostprocessorInstance(): Not implemented yet.");
    }
