...
public class DFlowFMSpatialRoughnessFileTest extends TestCase {
	...
	public void testReadAndWrite() {
		...
		assertEquals(14, exchangeItemIDs.length);
		...
		String[] expectedIds = {"Main-model_wide-Chezy",
			...
			"Main-Manning-Channel_1D_1_A-x0-q3",
			"Main-Manning-Channel_1D_1_A-x0-q4",
			"Main-Manning-Channel_1D_1_A-x500-q0",
			"Main-Manning-Channel_1D_1_A-x500-q1",
			"Main-Manning-Channel_1D_1_A-x500-q2",
			"Main-Manning-Channel_1D_1_A-x500-q3",
			"Main-Manning-Channel_1D_1_A-x500-q4",
		...
		IExchangeItem x0q1 = checkEI(dFlowFMSpatialRoughnessFile, "Main-Manning-Channel_1D_1_A-x0-q1", new double[]{0.029});
		x0q1.setValuesAsDoubles(new double[]{0.0345});
		IExchangeItem x0q2 = checkEI(dFlowFMSpatialRoughnessFile, "Main-Manning-Channel_1D_1_A-x0-q2", new double[]{0.029});
		x0q2.setValuesAsDoubles(new double[]{0.0579});
		IExchangeItem x0q3 = checkEI(dFlowFMSpatialRoughnessFile, "Main-Manning-Channel_1D_1_A-x0-q3", new double[]{0.028});
		x0q3.setValuesAsDoubles(new double[]{0.0347});
		IExchangeItem x0q4 = checkEI(dFlowFMSpatialRoughnessFile, "Main-Manning-Channel_1D_1_A-x0-q4", new double[]{0.027});
		x0q4.setValuesAsDoubles(new double[]{0.0581});
		IExchangeItem x500q0 = checkEI(dFlowFMSpatialRoughnessFile, "Main-Manning-Channel_1D_1_A-x500-q0", new double[]{0.03, 0.025});
		x500q0.setValuesAsDoubles(new double[]{0.02978, 0.02963});
		IExchangeItem x500q1 = checkEI(dFlowFMSpatialRoughnessFile, "Main-Manning-Channel_1D_1_A-x500-q1", new double[]{0.025, 0.025});
		x500q1.setValuesAsDoubles(new double[]{0.02576, 0.02634});
		IExchangeItem x500q2 = checkEI(dFlowFMSpatialRoughnessFile, "Main-Manning-Channel_1D_1_A-x500-q2", new double[]{0.026, 0.023});
		x500q2.setValuesAsDoubles(new double[]{0.02513, 0.02346});
		IExchangeItem x500q3 = checkEI(dFlowFMSpatialRoughnessFile, "Main-Manning-Channel_1D_1_A-x500-q3", new double[]{0.0259, 0.022});
		x500q3.setValuesAsDoubles(new double[]{0.02576, 0.02634});
		IExchangeItem x500q4 = checkEI(dFlowFMSpatialRoughnessFile, "Main-Manning-Channel_1D_1_A-x500-q4", new double[]{0.0258, 0.021});
