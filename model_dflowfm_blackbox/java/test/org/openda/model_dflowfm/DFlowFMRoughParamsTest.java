...
public class DFlowFMRoughParamsTest  extends TestCase {
    ...
    public void testExistingfile(){
        ...
        roughFile.initialize(testRunDataDir, "ruw.ttd",new String[]{});
    ...
    public void testExistingfile_2(){
    	...
    	File dataDir=testRunDataDir;
        DFlowFMTrachytopeFile roughFile=new DFlowFMTrachytopeFile();
        roughFile.initialize(testRunDataDir, "ruwQ7020.ttd",new String[]{});
    ...
    public void test1(){
        ...
        DFlowFMRoughnessUtils.writeWholeFile(roughFile, sContent);

        // Now Create some Exchange Items
        DFlowFMRougnessFileExchangeItem ex1= new DFlowFMRougnessFileExchangeItem("Param1", roughFile,  2, "A");
        DFlowFMRougnessFileExchangeItem ex2= new DFlowFMRougnessFileExchangeItem("Param2", roughFile,  2, "B");
        DFlowFMRougnessFileExchangeItem ex3= new DFlowFMRougnessFileExchangeItem("Param3", roughFile,  3, "A");
        DFlowFMRougnessFileExchangeItem ex4= new DFlowFMRougnessFileExchangeItem("Param4", roughFile,  4, "A");
        DFlowFMRougnessFileExchangeItem ex5= new DFlowFMRougnessFileExchangeItem("Param5", roughFile,  4, "B");
    ...
    public void test2(){
        ...
        DFlowFMTrachytopeFile paramsFile=new DFlowFMTrachytopeFile();
    ...
    private String[] testFile(){
        ...
        sContent[ 0]="# This is an example roughness include file for Delft3D-FM";
