...
public class BcFileTest extends TestCase
{
	...
	public void testBcFileReadThrowsExceptionForInvalidFile_MissingData()
	{
		Exception expectedException = null;
	...
	public void testBcFileReadThrowsExceptionForInvalidFile_NonDoubleData()
	{
		Exception expectedException = null;
		BcFile bcFile = new BcFile();
		try
	...
	public void testBcFileReadWriteGeneratesExpectedFile()
	{
