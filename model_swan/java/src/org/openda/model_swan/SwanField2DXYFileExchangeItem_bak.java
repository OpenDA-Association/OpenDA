 ...
 */
public class SwanField2DXYFileExchangeItem_bak implements IExchangeItem {
    private String id;
    private SwanField2DXYFile_bak swanWindFile;
//    private String direction;
    private Integer iTimeX = -1;
    private Integer iTimeY = -1;
    private Integer iTimeXY = -1;

    public SwanField2DXYFileExchangeItem_bak(String id, SwanField2DXYFile_bak swanWindFile){
        this.id = id;
