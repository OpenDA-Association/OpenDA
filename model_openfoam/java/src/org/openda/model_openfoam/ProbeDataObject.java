 ...
 */
public class ProbeDataObject implements IDataObject {
    ...
    public void initialize(File workingDir, String[] arguments) {
        ...
        if ( arguments.length == 0 ) {
			...
			throw new RuntimeException("Reference datetime is required as argument when initilazing");
		}
				...
				while (scanner.hasNext(Pattern.compile("#"))) {
					...
					if (scanner.findInLine("# Probe") != null) {
						...
						if (probeNr == nrProbes) {
							...
							logger.debug(String.format("( %f , %f, %f )", coordinates[0], coordinates[1], coordinates[2]));
							nrProbes++;
							scanner.nextLine();
						}
					} else {
